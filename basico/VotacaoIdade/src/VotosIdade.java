 ...
 * @author claudiney
 */
public class VotosIdade extends javax.swing.JFrame {

    /**
     * Creates new form VotosIdade
     */
    public VotosIdade() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VotosIdade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VotosIdade().setVisible(true);
            }
        });
    }
